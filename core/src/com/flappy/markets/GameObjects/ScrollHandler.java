...
public class ScrollHandler {
   ...
   // private Poop poop1, poop2, poop3, poop4, poop5, poop6, poop7, poop8, poop9, poop10;
    ...
    public static final int POOP_GAP = 10;
...
//        poop1.onRestart(0, SCROLL_SPEED);
//        poop2.onRestart(poop1.getTailX() + POOP_GAP, SCROLL_SPEED);
//        poop3.onRestart(poop2.getTailX() + POOP_GAP, SCROLL_SPEED);
//        poop4.onRestart(poop3.getTailX() + POOP_GAP, SCROLL_SPEED);
//        poop5.onRestart(poop4.getTailX() + POOP_GAP, SCROLL_SPEED);
//        poop6.onRestart(poop5.getTailX() + POOP_GAP, SCROLL_SPEED);
//        poop7.onRestart(poop6.getTailX() + POOP_GAP, SCROLL_SPEED);
//        poop8.onRestart(poop7.getTailX() + POOP_GAP, SCROLL_SPEED);
//        poop9.onRestart(poop8.getTailX() + POOP_GAP, SCROLL_SPEED);
//        poop10.onRestart(poop9.getTailX() + POOP_GAP, SCROLL_SPEED);
