...
public class MarketDataProvider {
    ...
    double[] signals;
    private static final double[] allPrices = new double[] {
            16.97,
            16.82,
            16.88,
            16.87,
    ...
    public MarketDataProvider(int dataCount) {
        ...
        this.indexOffset = (int) Math.random() * (allPrices.length - dataCount);
    }

    public double get(int index) {
        if (adjustedIndex(index) < allPrices.length) return allPrices[adjustedIndex(index)];
